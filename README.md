...
Deploy the AI-Q Blueprint and NVIDIA RAG Blueprint using NVIDIA Hosted Endpoints. 

In this case a single CPU VM is enough with minimum 64GIB RAM, 8vCPUs

### Option 2. GPU
Deploy the AI-Q Blueprint and NVIDIA RAG Blueprint  using **self-hosted NIMs**

In this case select the compute resources appropiated for the models to be hosted. 
